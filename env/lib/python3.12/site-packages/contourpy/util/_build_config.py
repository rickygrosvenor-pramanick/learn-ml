...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/Users/rickypramanick/Desktop/learn-ml/env/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/Users/runner/miniforge3/conda-bld/contourpy_1712429958595/work/.mesonpy-rw02_h9t/lib/contourpy/util",
        source_dir=r"/Users/runner/miniforge3/conda-bld/contourpy_1712429958595/work/lib/contourpy/util",
        cross_build="True",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --cross-file=/Users/runner/miniforge3/conda-bld/contourpy_1712429958595/_build_env/meson_cross_file.txt --native-file=/Users/runner/miniforge3/conda-bld/contourpy_1712429958595/work/.mesonpy-rw02_h9t/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
